<?php
//Asigno a variables de pp los valores que vienen del formulario
...
//verficamos que no exista previamente el email del usuario en la BD
...
if($num_regs==0){
    ...
    if($ejecutar_consulta)
        ...
        $mensaje = "No se pudo dar de alta al contaco con el email <b> $email</b> :(";
}
else{
