<?php
//El parametro de $extension determina que tipo de imagen no se borrará por ejemplo si es jpg significa que la imagen con estensión .jpg se queda en el servidor y si existen imagenes con el mismo nombre pero con extension png o fig se eliminaran, con esta funicon evito tener imagenes duplicadas con distinta extensiones para cada perfil la funion file_exists evalua si un archivo existe y la funicon unlink borra un archivo del servidor
...
function subir_imagen($tipo,$imagen,$email){
    //strstr($cadena1,$cadena2) sirve para evaluar si en la primera cadena de texto existe la sgunda cadena de texto
    //si dentro del tipo del archivo se encuentra la palabra image significa que el archivo es una imagen
    if(strstr($tipo,"image"))
    {
        //para saber de que tipo de extesnsion es la imagen
        if(strstr($tipo,"jpeg"))
            $extension = ".jpg";
        ...
        if($ancho_img>$ancho_img_deseado)
        {
            ...
            //Creo una imagen basada en la original, dependiendo de su extension es el tipo que crear
            switch ($extension) {
                case ".jpg":
        ...
        //Asigo el nombre de la foto que se guardara en la BD como cadena de texo
